    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      {loading && logs.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 space-y-4">
          ...
          <p className="text-[9px] font-bold tracking-[0.3em] uppercase opacity-40">Carregando histórico...</p>
        </div>
      ) : (
          ...
          <AnimatePresence initial={false}>
            {groupedList.map((item, idx) => {
              ...
              return (
                ...
                >
                  <Card className="border border-primary/5 shadow-xl hover:shadow-2xl rounded-none p-6 space-y-5 bg-white hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between h-full relative overflow-hidden group">
