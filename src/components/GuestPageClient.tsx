      ...
      <div className={WRAP}>
        ...
        <header className="pt-14 sm:pt-20 pb-12 space-y-5 animate-in fade-in slide-in-from-top duration-1000">
          <div className="flex items-center gap-3">
            ...
            <p className="tracking-[0.5em] uppercase opacity-40 font-bold" style={{ fontSize: "22px" }}>Convite Pessoal</p>
          </div>
          <div>
            <p className="tracking-[0.4em] uppercase opacity-30 mb-2" style={{ fontSize: "22px" }}>Para</p>
